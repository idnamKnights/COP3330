package dimassino_p3;

import java.util.Scanner;

public class Asgn2Prob3 {
	
	   public static void main(String args[]){
	       String[] topic={"Noms","Video Games","Furrbabies","Reading","Education"}; //My topics.
	       ...
	       int peoples;
	       System.out.print("Enter the number of people participating to rate between 1-10 for the topics: "); //Input the no of people willing to vote.
	       ...
	       System.out.println("Topics "+"Total Ratings "+"Avg Ratings");
	       ...
	       System.out.println("Highest Topic "+"Total Ratings");
	       System.out.println(topic[max_topic]+" "+max_p);
	       System.out.println("Lowest Topic "+"Total Ratings");
